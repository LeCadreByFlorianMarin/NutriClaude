...
- **Cibles tactiles ≥ 44px** — ligne-article 46/48px, **zone de tap = la ligne entière** (un seul hit-target par ligne ; la quantité, la pastille « arrive… » et l'icône de provenance à droite n'interceptent jamais le tap). Bascule idempotente au tap (NFR-2).
